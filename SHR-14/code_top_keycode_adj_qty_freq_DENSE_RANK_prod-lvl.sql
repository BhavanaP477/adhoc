...
SELECT 
    A.PRODUCT_GENERATED_IDENTIFIER, A.PRODUCT_DESCRIPTION, A.DEPARTMENT_DESCRIPTION, A.DEPARTMENT_SOURCE_IDENTIFIER,
    ...
    (SELECT
     ...
     FROM
        ( SELECT
          ...
          FROM
            ( SELECT
                A.LOCATION_GENERATED_IDENTIFIER, A.PRODUCT_GENERATED_IDENTIFIER,
              ...
              FROM
                KSFPA.IPS_STOCK_AUDIT.IPS_STOCK_AUDIT A
