CREATE TABLE KSFDA.SHRINK_TACTICAL.MR_DATA6 AS
  (
WITH
W_MANIFEST AS (
  SELECT DISTINCT
  ...
  AND PRD.EFFECTIVE_DATE >= '2022-02-20' AND PRD.EFFECTIVE_DATE <= '2023-02-26'
...
W_SALES AS (
  ...
  WHERE
  WEEK_END_DATE >= '2022-02-20' AND WEEK_END_DATE <= '2023-02-26'
  GROUP BY
  PRODUCT_GENERATED_IDENTIFIER,
  LOCATION_GENERATED_IDENTIFIER
),
...
W_SHRINK AS (
  ...
  AND PERIOD_END_DATE >= '2022-02-20' AND PERIOD_END_DATE <= '2023-02-26'
  GROUP BY
  PRODUCT_GENERATED_IDENTIFIER,
  LOCATION_GENERATED_IDENTIFIER
),
...
W_PO AS (
  ...
  WHERE
  LOC_PROD.EXPIRY_DATE = '9999-12-31' AND  LOC_PROD.EFFECTIVE_DATE >= '2022-02-20' AND LOC_PROD.EFFECTIVE_DATE <= '2023-02-26'
...
W_ITC AS (
  ...
  AND DES_ITC.EFFECTIVE_DATE >= '2022-02-20' AND DES_ITC.EFFECTIVE_DATE <= '2023-02-26'
  GROUP BY 
...
W_RLO AS (
  ...
  AND DES_RLO.EFFECTIVE_DATE >= '2022-02-20' AND DES_RLO.EFFECTIVE_DATE <= '2023-02-26'
  GROUP BY 
