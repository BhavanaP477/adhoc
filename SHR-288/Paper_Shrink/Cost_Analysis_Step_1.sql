CREATE OR REPLACE TABLE KSFDA.SHRINK_TACTICAL.PAPER_SHRINK_COST_ANALYSIS_Step_1 AS
(
...
--((IPS_PO- MR_PO)) as DIFF_PO, LOCATION_AWC_AMOUNT * DIFF_PO 
  0 AS PO_COST,
(("IPS_Dervied_SOH" - "MR_Dervied_SOH")) as DIFF_SOH
FROM "KSFDA"."SHRINK_TACTICAL"."PAPER_SHRINK_DETAILED_ALL" A
