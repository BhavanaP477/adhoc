DROP TABLE KSFPA.LOSS_PREVENTION_PVT.LAST_STK_PROD_LOC_SHRINK_SLS;
CREATE TABLE KSFPA.LOSS_PREVENTION_PVT.LAST_STK_PROD_LOC_SHRINK_SLS AS
...
A.LAST_STK_START_DATE, A.LAST_STK_END_DATE,
A.LAST_STK_DATE, A.LAST_LAST_STK_DATE,
...
SS_STK_ADJ.code36_neg_adj_qty, SS_STK_ADJ.code37_neg_adj_qty, SS_STK_ADJ.codeNP_neg_adj_qty,
...
SS_STK_ADJ.code36_pos_adj_qty, SS_STK_ADJ.code37_pos_adj_qty, SS_STK_ADJ.codeNP_pos_adj_qty,
...
SS_STK_ADJ.code36_neg_adj_amt, SS_STK_ADJ.code37_neg_adj_amt, SS_STK_ADJ.codeNP_neg_adj_amt,
...
SS_STK_ADJ.code36_pos_adj_amt, SS_STK_ADJ.code37_pos_adj_amt, SS_STK_ADJ.codeNP_pos_adj_amt


from
(select distinct PRODUCT_GENERATED_IDENTIFIER, LOCATION_GENERATED_IDENTIFIER,
LAST_STK_START_DATE, LAST_STK_END_DATE, LAST_STK_DATE, LAST_LAST_STK_DATE
from
(select distinct A.PRODUCT_GENERATED_IDENTIFIER, A.LOCATION_GENERATED_IDENTIFIER,
B.LAST_STK_START_DATE, B.LAST_STK_END_DATE, B.LAST_STK_DATE, B.LAST_LAST_STK_DATE
from KSFPA.MR2C.WEEKLY_ADJUSTED_SALES A
inner join KSFPA.LOSS_PREVENTION_PVT.STK_STRS_WITH_STK_DATE_VD B
on A.LOCATION_GENERATED_IDENTIFIER = B.LOCATION_GENERATED_IDENTIFIER
where A.WEEK_END_DATE >= B.LAST_STK_START_DATE
and A.WEEK_END_DATE <= B.LAST_STK_END_DATE
...
inner join KSFPA.LOSS_PREVENTION_PVT.STK_STRS_WITH_STK_DATE_VD B
on A.LOCATION_GENERATED_IDENTIFIER = B.LOCATION_GENERATED_IDENTIFIER
where A.PERIOD_END_DATE >= B.LAST_STK_START_DATE
and A.PERIOD_END_DATE <= B.LAST_STK_END_DATE
and B.LAST_LAST_STK_DATE is NOT NULL
and A.STOCK_ADJUSTMENT_COST_AMOUNT != 0) ) A
...
sum(A.STOCK_ADJUSTMENT_QUANTITY) as net_adj_amt,
...
sum(case when (A.STOCK_ADJUSTMENT_REASON_CODE in ('02', '04', '05', '06', '17', '20', '34', '36', 'NP') ) then A.STOCK_ADJUSTMENT_QUANTITY else 0 end) as unknown_shrink_qty,
sum(case when (A.STOCK_ADJUSTMENT_REASON_CODE in ('00', '03', '07', '08', '11', '21', '29', '35', '37', 'NS') ) then A.STOCK_ADJUSTMENT_QUANTITY else 0 end) as known_shrink_qty,
sum(case when (A.STOCK_ADJUSTMENT_REASON_CODE in ('02', '04', '05', '06', '17', '20', '34', '36', 'NP') ) then A.STOCK_ADJUSTMENT_COST_AMOUNT else 0 end) as unknown_shrink_amt,
sum(case when (A.STOCK_ADJUSTMENT_REASON_CODE in ('00', '03', '07', '08', '11', '21', '29', '35', '37', 'NS') ) then A.STOCK_ADJUSTMENT_COST_AMOUNT else 0 end) as known_shrink_amt,
...
where C.DEPARTMENT_DESCRIPTION NOT IN ('GIFT CARDS & RCHRG','PHOTO CENTRE');
...
A.TOT_SHRINK_AMT_ZERO_SLS, A.TOT_SHRINK_AMT,
...
D.NEG_SOH_SELL_AMT, D.NEG_SOH_PROD_CNT
from
(select A.LOCATION_SOURCE_IDENTIFIER, A.LOCATION_GENERATED_IDENTIFIER,
...
(code37_neg_adj_qty+code37_pos_adj_qty) AS ONLINE_SHRINK_QTY,
(code37_neg_adj_amt+code37_pos_adj_amt) AS ONLINE_SHRINK_AMT,
(code37_neg_adj_qty+code37_pos_adj_qty) AS HEAD_OFFICE_ADJ_QTY,
(code37_neg_adj_amt+code37_pos_adj_amt) AS HEAD_OFFICE_ADJ_AMT,
...
from KSFPA.LOSS_PREVENTION_PVT.LAST_STK_PROD_LOC_SHRINK_SLS A )A
group by 1,2) A
...
left join KSFPA.IPS_SALES.TRN_REFUND as C
on A.M_TRN_ID = C.M_TRN_ID
and A.M_STORE = C.M_STORE
and A.D_TRN_DATE = C.D_TRN_DATE
where A.D_TRN_DATE >= B.LAST_STK_START_DATE
and A.D_TRN_DATE <= B.LAST_STK_END_DATE
and B.LAST_LAST_STK_DATE is NOT NULL
...
inner join
(select distinct PRODUCT_GENERATED_IDENTIFIER, LOCATION_GENERATED_IDENTIFIER
from KSFPA.LOSS_PREVENTION_PVT.LAST_STK_PROD_LOC_SHRINK_SLS) B
...
inner join KSFPA.LOSS_PREVENTION_PVT.STK_STRS_WITH_STK_DATE_VD D
on A.LOCATION_GENERATED_IDENTIFIER = D.LOCATION_GENERATED_IDENTIFIER
where A.DAY_DATE >= D.LAST_STK_START_DATE
and A.DAY_DATE <= D.LAST_STK_END_DATE
...
sum(A.STOCK_ON_HAND_SELL_AMOUNT) as NEG_SOH_SELL_AMT,
...
inner join KSFPA.LOSS_PREVENTION_PVT.STK_STRS_WITH_STK_DATE_VD D
on A.LOCATION_GENERATED_IDENTIFIER = D.LOCATION_GENERATED_IDENTIFIER
where A.WEEK_END_DATE = DATEADD(DAY,-7,D.LAST_STK_DATE)
and D.LAST_LAST_STK_DATE IS NOT NULL
...
FROM
(select distinct LOCATION_GENERATED_IDENTIFIER, PERIOD_END_DATE, 
'STK_ADJ' AS ADJ_TYPE
...
and A.STOCK_ADJUSTMENT_REASON_CODE IN ('00', '02', '03', '04', '05', '06', '07', '08', '11', '17', '20', '21', '29', '34', '35', '36', '37', 'NS', 'NP')) ) A
...
sum(case when (A.STOCK_ADJUSTMENT_QUANTITY < 0) then A.STOCK_ADJUSTMENT_COST_AMOUNT else 0 end) as net_neg_adj_amt,
sum(case when (A.STOCK_ADJUSTMENT_QUANTITY > 0) then A.STOCK_ADJUSTMENT_COST_AMOUNT else 0 end) as net_pos_adj_amt,
sum(case when (A.STOCK_ADJUSTMENT_REASON_CODE in ('02', '04', '05', '06', '17', '20', '29', '34', '36', '37', 'NS', 'NP') ) then A.STOCK_ADJUSTMENT_QUANTITY else 0 end) as unknown_shrink_qty,
sum(case when (A.STOCK_ADJUSTMENT_REASON_CODE in ('00', '03', '07', '08', '11', '21', '35') ) then A.STOCK_ADJUSTMENT_QUANTITY else 0 end) as known_shrink_qty,
sum(case when (A.STOCK_ADJUSTMENT_REASON_CODE in ('02', '04', '05', '06', '17', '20', '29', '34', '36', '37', 'NS', 'NP') ) then A.STOCK_ADJUSTMENT_COST_AMOUNT else 0 end) as unknown_shrink_amt,
sum(case when (A.STOCK_ADJUSTMENT_REASON_CODE in ('00', '03', '07', '08', '11', '21', '35') ) then A.STOCK_ADJUSTMENT_COST_AMOUNT else 0 end) as known_shrink_amt,
...
where A.PERIOD_END_DATE >= B.START_DATE
and A.PERIOD_END_DATE <= B.END_DATE
and A.STOCK_ADJUSTMENT_REASON_CODE IN ('00', '02', '03', '04', '05', '06', '07', '08', '11', '17', '20', '21', '29', '34', '35', '36', '37', 'NS', 'NP')
--and B.LAST_LAST_STK_DATE is NOT NULL
...
(B.Refund_Tran/B.Total_Tran) AS REFUND_TRAN_PERCENT,
(B.TOTAL_REFUND_QTY/A.TOT_SALES_QTY) AS REFUND_QTY_PERCENT,
(B.Refund_no_receipt_Tran/B.Refund_Tran) AS REFUND_NO_RECEIPT_PERCENT,
(B.TOTAL_Refund_no_receipt_QTY/B.TOTAL_REFUND_QTY) AS REFUND_NO_RECEIPT_QTY_PERCENT,
(B.Self_Checkout_Tran/B.Purchase_Tran) AS SELF_CHECKOUT_PERCENT,
(A.AVG_GAPSCAN_AMT/E.AVG_SOH_COST_AMT) AS AVG_GAPSCAN_AMT_PERCENT,
(A.AVG_GAPSCAN_QTY/E.AVG_SOH_QTY) AS AVG_GAPSCAN_QTY_PERCENT,
(A.AVG_HEAD_OFFICE_ADJ_AMT/E.AVG_SOH_COST_AMT) AS AVG_HEAD_OFFICE_AMT_PERCENT,
(A.AVG_HEAD_OFFICE_ADJ_QTY/E.AVG_SOH_QTY) AS AVG_HEAD_OFFICE_QTY_PERCENT,
(C.HOUSE_MANIFEST_QTY/C.ALL_MANIFEST_QTY) AS HOUSE_MANIFEST_QTY_PERCENT,
--(D.NEG_SOH_QTY/E.AVG_SOH_QTY) AS NEG_SOH_QTY_PERCENT,
(E.AVG_NEG_SOH_QTY/E.AVG_SOH_QTY) AS AVG_NEG_SOH_QTY_PERCENT,
(E.AVG_NEG_SOH_COST_AMT/E.AVG_SOH_COST_AMT) AS AVG_NEG_SOH_AMT_PERCENT,
(E.AVG_NEG_SOH_PROD_CNT/E.AVG_PROD_CNT) AS AVG_NEG_SOH_PROD_CNT_PERCENT,
(A.TOT_KNOWN_SHRINK_AMT/A.TOT_SALES_AMT) AS KNOWN_SHRINK_AMT_PERCENT,
(A.ALL_SHRINK_WO_STK_AMT/A.TOT_SALES_AMT) AS ALL_SHRINK_WO_STK_AMT_PERCENT,
(A.COSMETIC_KNOWN_SHRINK/COSMETIC_NET_SLS) AS COSMETIC_KNOWN_SR_RATE,
(A.APPLIANCE_KNOWN_SHRINK/APPLIANCE_NET_SLS) AS APPLIANCE_KNOWN_SR_RATE,
(A.DOLL_KNOWN_SHRINK/DOLL_NET_SLS) AS DOLL_KNOWN_SR_RATE,
(A.TOY_KNOWN_SHRINK/TOY_NET_SLS) AS TOY_KNOWN_SR_RATE,
(A.FAMILY_TECH_KNOWN_SHRINK/FAMILY_TECH_NET_SLS) AS FAMILY_TECH_KNOWN_SR_RATE,
(A.COSMETIC_ALL_SHRINK/COSMETIC_NET_SLS) AS COSMETIC_ALL_SR_RATE,
(A.APPLIANCE_ALL_SHRINK/APPLIANCE_NET_SLS) AS APPLIANCE_ALL_SR_RATE,
(A.DOLL_ALL_SHRINK/DOLL_NET_SLS) AS DOLL_ALL_SR_RATE,
(A.TOY_ALL_SHRINK/TOY_NET_SLS) AS TOY_ALL_SR_RATE,
(A.FAMILY_TECH_ALL_SHRINK/FAMILY_TECH_NET_SLS) AS FAMILY_TECH_ALL_SR_RATE,
(F.DIF_ORDERS/F.ALL_ORDERS) AS ONLINE_FIRST_DIF_PERCENT,
(G.DIST_TRNS_WITH_INTRVNS/G.TOTAL_TRNS) AS SCO_INTERVENTION_PERCENT
from
(select A.LOCATION_SOURCE_IDENTIFIER, A.LOCATION_GENERATED_IDENTIFIER,
A.ADJ_START_DATE, A.START_DATE, A.START_DATE_ADJ_TYPE, 
A.ADJ_END_DATE, A.END_DATE, A.END_DATE_ADJ_TYPE,
...
(A.net_adj_qty - (code4_neg_adj_qty+code4_pos_adj_qty+code17_neg_adj_qty+code17_pos_adj_qty)) as ALL_SHRINK_WO_STK_QTY,
(A.net_adj_amt - (code4_neg_adj_amt+code4_pos_adj_amt+code17_neg_adj_amt+code17_pos_adj_amt)) as ALL_SHRINK_WO_STK_AMT,
(code20_neg_adj_qty+code20_pos_adj_qty) AS TOT_GAPSCAN_QTY,
(code20_neg_adj_amt+code20_pos_adj_amt) AS TOT_GAPSCAN_AMT,
(code37_neg_adj_qty+code37_pos_adj_qty) AS ONLINE_SHRINK_QTY,
(code37_neg_adj_amt+code37_pos_adj_amt) AS ONLINE_SHRINK_AMT,
...
FROM KSF_SOPHIA_DATA_INTELLIGENCE_HUB_DEV.SHRINK_TACTICAL.AGG_SHRINK_ONLINE_DIF_PERCENTAGE DIF
...
and A.STOCK_ADJUSTMENT_REASON_CODE IN ('20')
group by 1,2,3,4,5) A
group by 1,2,3,4) H
...
DROP TABLE KSFPA.LOSS_PREVENTION_PVT.LAST_STK_TEST_PROD_LOC_SHRINK_SLS;
CREATE TABLE KSFPA.LOSS_PREVENTION_PVT.LAST_STK_TEST_PROD_LOC_SHRINK_SLS AS
SELECT A.PRODUCT_GENERATED_IDENTIFIER, C.PRODUCT_SOURCE_IDENTIFIER,
C.PRODUCT_DESCRIPTION, C.DEPARTMENT_SOURCE_IDENTIFIER, C.DEPARTMENT_DESCRIPTION, 
C.RBU_DESCRIPTION, C.BRAND_DESCRIPTION, C.HOUSEBRAND_NAME, 
C.BRAND_LABEL_DESCRIPTION, kc_flexi.BRAND_LABEL_TYPE,
...
on A.LOCATION_GENERATED_IDENTIFIER = B.LOCATION_GENERATED_IDENTIFIER
where A.PERIOD_END_DATE >= B.START_DATE
and A.PERIOD_END_DATE <= '2020-11-29'
and B.END_DATE = '2021-03-07'
and A.STOCK_ADJUSTMENT_COST_AMOUNT != 0
and A.STOCK_ADJUSTMENT_REASON_CODE IN ('00', '02', '03', '04', '05', '06', '07', '08', '11', '17', '20', '21', '29', '34', '35', '36', '37', 'NS', 'NP')) ) A
...
sum(case when (A.STOCK_ADJUSTMENT_QUANTITY < 0) then A.STOCK_ADJUSTMENT_COST_AMOUNT else 0 end) as net_neg_adj_amt,
sum(case when (A.STOCK_ADJUSTMENT_QUANTITY > 0) then A.STOCK_ADJUSTMENT_COST_AMOUNT else 0 end) as net_pos_adj_amt,
sum(case when (A.STOCK_ADJUSTMENT_REASON_CODE in ('02', '04', '05', '06', '17', '20', '29', '34', '36', '37', 'NP', 'NS') ) then A.STOCK_ADJUSTMENT_QUANTITY else 0 end) as unknown_shrink_qty,
sum(case when (A.STOCK_ADJUSTMENT_REASON_CODE in ('00', '03', '07', '08', '11', '21', '35') ) then A.STOCK_ADJUSTMENT_QUANTITY else 0 end) as known_shrink_qty,
sum(case when (A.STOCK_ADJUSTMENT_REASON_CODE in ('02', '04', '05', '06', '17', '20', '29', '34', '36', '37', 'NP', 'NS') ) then A.STOCK_ADJUSTMENT_COST_AMOUNT else 0 end) as unknown_shrink_amt,
sum(case when (A.STOCK_ADJUSTMENT_REASON_CODE in ('00', '03', '07', '08', '11', '21', '35') ) then A.STOCK_ADJUSTMENT_COST_AMOUNT else 0 end) as known_shrink_amt,
...
C.ALL_MANIFEST_QTY, D.NEG_SOH_QTY,
D.NEG_SOH_SELL_AMT, D.NEG_SOH_PROD_CNT,
(B.Refund_Tran/B.Total_Tran) AS REFUND_PERCENT,
(B.Refund_no_receipt_Tran/B.Refund_Tran) AS REFUND_NO_RECEIPT_PERCENT,
(B.Self_Checkout_Tran/B.Purchase_Tran) AS SELF_CHECKOUT_PERCENT,
(A.TOT_GAPSCAN_AMT/A.TOT_SALES_AMT) AS GAPSCAN_AMT_PERCENT,
(A.HEAD_OFFICE_ADJ_AMT/A.TOT_SALES_AMT) AS HEAD_OFFICE_AMT_PERCENT,
(C.HOUSE_MANIFEST_QTY/C.ALL_MANIFEST_QTY) AS HOUSE_MANIFEST_QTY_PERCENT,
(D.NEG_SOH_QTY/A.TOT_SALES_QTY) AS NEG_SOH_QTY_PERCENT,
(D.NEG_SOH_PROD_CNT/A.PROD_CNT) AS NEG_SOH_PROD_CNT_PERCENT
from
(select A.LOCATION_SOURCE_IDENTIFIER, A.LOCATION_GENERATED_IDENTIFIER,
A.ADJ_START_DATE, A.START_DATE, A.START_DATE_ADJ_TYPE, 
A.ADJ_END_DATE, A.END_DATE, A.END_DATE_ADJ_TYPE,
...
from
(select A.PRODUCT_SOURCE_IDENTIFIER, A.LOCATION_SOURCE_IDENTIFIER,
A.LOCATION_GENERATED_IDENTIFIER, A.ADJ_START_DATE, A.START_DATE, 
A.START_DATE_ADJ_TYPE, A.ADJ_END_DATE, A.END_DATE, A.END_DATE_ADJ_TYPE,
A.net_adj_qty as TOT_SHRINK_QTY, A.net_adj_amt as TOT_SHRINK_AMT,
A.net_sls_qty as TOT_SALES_QTY, A.net_sls_amt AS TOT_SALES_AMT,
(code20_neg_adj_qty+code20_pos_adj_qty) AS TOT_GAPSCAN_QTY,
(code20_neg_adj_amt+code20_pos_adj_amt) AS TOT_GAPSCAN_AMT,
(code37_neg_adj_qty+code37_pos_adj_qty) AS ONLINE_SHRINK_QTY,
(code37_neg_adj_amt+code37_pos_adj_amt) AS ONLINE_SHRINK_AMT,
...
case when A.NET_SLS_QTY<=0 then A.net_adj_amt else 0 end as TOT_SHRINK_AMT_ZERO_SLS,
case when A.NET_SLS_QTY<=0 then A.PRODUCT_SOURCE_IDENTIFIER end as PRODUCT_SOURCE_IDENTIFIER_ZERO_SLS 
from KSFPA.LOSS_PREVENTION_PVT.LAST_STK_TEST_PROD_LOC_SHRINK_SLS A )A
group by 1,2,3,4,5,6,7,8) A
...
inner join
(select distinct PRODUCT_GENERATED_IDENTIFIER, LOCATION_GENERATED_IDENTIFIER
from KSFPA.LOSS_PREVENTION_PVT.LAST_STK_TEST_PROD_LOC_SHRINK_SLS) B
on A.PRODUCT_GENERATED_IDENTIFIER = B.PRODUCT_GENERATED_IDENTIFIER
and A.LOCATION_GENERATED_IDENTIFIER = B.LOCATION_GENERATED_IDENTIFIER
inner join KSFPA.LOSS_PREVENTION_PVT.ALL_STRS_STK_DATE D
on A.LOCATION_GENERATED_IDENTIFIER = D.LOCATION_GENERATED_IDENTIFIER
where A.DAY_DATE >= D.START_DATE
and A.DAY_DATE <= '2020-11-29'
and D.END_DATE = '2021-03-07'
group by 1,2,3,4) C
on A.LOCATION_GENERATED_IDENTIFIER = C.LOCATION_GENERATED_IDENTIFIER
and A.START_DATE = C.START_DATE
...
inner join KSFPA.LOSS_PREVENTION_PVT.ALL_STRS_STK_DATE D
on A.LOCATION_GENERATED_IDENTIFIER = D.LOCATION_GENERATED_IDENTIFIER
where A.WEEK_END_DATE = '2020-11-29'
and D.END_DATE = '2021-03-07'
and A.STOCK_ON_HAND_QUANTITY < 0
group by 1,2,3,4) D
on A.LOCATION_GENERATED_IDENTIFIER = D.LOCATION_GENERATED_IDENTIFIER
...
-----------------------Creating Test data at quarters-------------------------------------------

DROP TABLE KSFPA.LOSS_PREVENTION_PVT.ALL_QRTR_TEST_STRS_STK_DATE;
CREATE TABLE KSFPA.LOSS_PREVENTION_PVT.ALL_QRTR_TEST_STRS_STK_DATE AS 
SELECT LOCATION_GENERATED_IDENTIFIER, LOCATION_SOURCE_IDENTIFIER,
START_DATE, END_QUARTER_DATE, END_QUARTER_DATE_TYPE, 
ADJ_START_DATE, ADJ_END_DATE
FROM
(SELECT *,
CASE WHEN DATEADD(WEEK,13,START_DATE) < ADJ_END_DATE THEN DATEADD(WEEK,13,START_DATE) END AS THIRD_MONTH_DATE,
CASE WHEN DATEADD(WEEK,26,START_DATE) < ADJ_END_DATE THEN DATEADD(WEEK,26,START_DATE) END AS SIXTH_MONTH_DATE,
CASE WHEN DATEADD(WEEK,39,START_DATE) < ADJ_END_DATE THEN DATEADD(WEEK,39,START_DATE) END AS NINTH_MONTH_DATE,
CASE WHEN DATEADD(WEEK,52,START_DATE) < ADJ_END_DATE THEN DATEADD(WEEK,52,START_DATE) END AS TWELFTH_MONTH_DATE
from KSFPA.LOSS_PREVENTION_PVT.ALL_STRS_STK_DATE
where ADJ_END_DATE = '2021-02-28'
and START_DATE_ADJ_TYPE = 'STK_ADJ')
UNPIVOT (END_QUARTER_DATE FOR END_QUARTER_DATE_TYPE IN (THIRD_MONTH_DATE, SIXTH_MONTH_DATE, NINTH_MONTH_DATE, TWELFTH_MONTH_DATE, END_DATE))
ORDER BY LOCATION_SOURCE_IDENTIFIER, END_QUARTER_DATE;



------------------------------------------------------------------------------------------------

DROP TABLE KSFPA.LOSS_PREVENTION_PVT.ALL_STK_QRTR_TEST_PROD_LOC_SHRINK_SLS;
CREATE TABLE KSFPA.LOSS_PREVENTION_PVT.ALL_STK_QRTR_TEST_PROD_LOC_SHRINK_SLS AS
SELECT A.PRODUCT_GENERATED_IDENTIFIER, C.PRODUCT_SOURCE_IDENTIFIER,
C.PRODUCT_DESCRIPTION, C.DEPARTMENT_SOURCE_IDENTIFIER, C.DEPARTMENT_DESCRIPTION, 
C.RBU_DESCRIPTION, C.BRAND_DESCRIPTION, C.HOUSEBRAND_NAME, 
C.BRAND_LABEL_DESCRIPTION, kc_flexi.BRAND_LABEL_TYPE,
...
B.LOCATION_SOURCE_IDENTIFIER, B.LOCATION_NAME, 
B.LOCATION_TYPE_CODE, B.DC_GROUP_ABBREV_NAME,
A.START_DATE, A.END_QUARTER_DATE, A.END_QUARTER_DATE_TYPE, 
A.ADJ_START_DATE, A.ADJ_END_DATE,
SS_STK_ADJ.net_adj_qty, SS_STK_ADJ.net_adj_amt,
SALES.net_sls_qty, SALES.net_sls_amt,
SS_STK_ADJ.net_neg_adj_qty, SS_STK_ADJ.net_pos_adj_qty,
SS_STK_ADJ.net_neg_adj_amt, SS_STK_ADJ.net_pos_adj_amt,
...
from
(select distinct A.PRODUCT_GENERATED_IDENTIFIER, A.LOCATION_GENERATED_IDENTIFIER,
B.START_DATE, B.END_QUARTER_DATE, B.END_QUARTER_DATE_TYPE,
B.ADJ_START_DATE, B.ADJ_END_DATE
from KSFPA.MR2C.WEEKLY_ADJUSTED_SALES A
inner join KSFPA.LOSS_PREVENTION_PVT.ALL_QRTR_TEST_STRS_STK_DATE B
on A.LOCATION_GENERATED_IDENTIFIER = B.LOCATION_GENERATED_IDENTIFIER
where A.WEEK_END_DATE >= B.START_DATE
and A.WEEK_END_DATE <= B.END_QUARTER_DATE
--and B.LAST_LAST_STK_DATE is NOT NULL
and A.WEEKLY_NET_SELL_AMOUNT != 0) 
UNION 
(select distinct A.PRODUCT_GENERATED_IDENTIFIER, A.LOCATION_GENERATED_IDENTIFIER,
...
on A.LOCATION_GENERATED_IDENTIFIER = B.LOCATION_GENERATED_IDENTIFIER
where A.PERIOD_END_DATE >= B.START_DATE
and A.PERIOD_END_DATE <= B.END_QUARTER_DATE
--and B.LAST_LAST_STK_DATE is NOT NULL
and A.STOCK_ADJUSTMENT_COST_AMOUNT != 0
and A.STOCK_ADJUSTMENT_REASON_CODE IN ('00', '02', '03', '04', '05', '06', '07', '08', '11', '17', '20', '21', '29', '34', '35', '36', '37', 'NS', 'NP')) ) A
...
left join
(select A.PRODUCT_GENERATED_IDENTIFIER, A.LOCATION_GENERATED_IDENTIFIER,
B.START_DATE, B.END_QUARTER_DATE,
sum(A.STOCK_ADJUSTMENT_QUANTITY) as net_adj_qty,
sum(A.STOCK_ADJUSTMENT_COST_AMOUNT) as net_adj_amt,
--F.TOT_NEG_SHRINK_AMT, F.TOT_POS_SHRINK_AMT, F.TOT_NEG_SHRINK_QTY, F.TOT_POS_SHRINK_QTY,
sum(case when (A.STOCK_ADJUSTMENT_QUANTITY < 0) then A.STOCK_ADJUSTMENT_QUANTITY else 0 end) as net_neg_adj_qty,
...
and A.PRODUCT_GENERATED_IDENTIFIER = SS_STK_ADJ.PRODUCT_GENERATED_IDENTIFIER
and A.START_DATE = SS_STK_ADJ.START_DATE
and A.END_QUARTER_DATE = SS_STK_ADJ.END_QUARTER_DATE
...
and A.PRODUCT_GENERATED_IDENTIFIER = SALES.PRODUCT_GENERATED_IDENTIFIER
and A.START_DATE = SALES.START_DATE
and A.END_QUARTER_DATE = SALES.END_QUARTER_DATE
where C.DEPARTMENT_DESCRIPTION not in ('GARDEN GREENS','MAGAZINES','REUSABLE BAGS','CARDS & WRAP','PHOTO CENTRE','GIFT CARDS & RCHRG');
...
select A.LOCATION_SOURCE_IDENTIFIER, A.LOCATION_GENERATED_IDENTIFIER,
A.START_DATE, A.END_QUARTER_DATE, 
A.END_QUARTER_DATE_TYPE, A.ADJ_START_DATE, A.ADJ_END_DATE,
A.TOT_SHRINK_QTY_ZERO_SLS, A.TOT_SHRINK_QTY,
A.TOT_SHRINK_AMT_ZERO_SLS, 
A.TOT_KNOWN_SHRINK_AMT, A.TOT_SHRINK_AMT,
A.TOT_SALES_QTY, A.TOT_SALES_AMT,
...
E.AVG_NEG_SOH_QTY, E.AVG_NEG_SOH_COST_AMT,
E.AVG_NEG_SOH_PROD_CNT, E.AVG_PROD_CNT,
B.Total_Tran/(((A.END_QUARTER_DATE-A.START_DATE)/7)+1) AS AVG_WEEKLY_TRAN,
H.GAPSCAN_PERCENT_WEEKS, H.AVG_GAPSCAN_PROD_CNT,
(B.Refund_Tran/B.Total_Tran) AS REFUND_TRAN_PERCENT,
(B.TOTAL_REFUND_QTY/A.TOT_SALES_QTY) AS REFUND_QTY_PERCENT,
(B.Refund_no_receipt_Tran/B.Refund_Tran) AS REFUND_NO_RECEIPT_PERCENT,
...
sum(A.TOT_SALES_QTY) as TOT_SALES_QTY,
sum(A.TOT_SALES_AMT) as TOT_SALES_AMT,
sum(A.TOT_SALES_AMT)/(((A.END_QUARTER_DATE-A.START_DATE)/7)+1) as AVG_SALES_AMT,
SUM(CASE WHEN A.DEPARTMENT_SOURCE_IDENTIFIER = 20 THEN A.KNOWN_SHRINK_AMT ELSE 0 END) AS COSMETIC_KNOWN_SHRINK,
SUM(CASE WHEN A.DEPARTMENT_SOURCE_IDENTIFIER = 56 THEN A.KNOWN_SHRINK_AMT ELSE 0 END) AS APPLIANCE_KNOWN_SHRINK,
SUM(CASE WHEN A.DEPARTMENT_SOURCE_IDENTIFIER = 67 THEN A.KNOWN_SHRINK_AMT ELSE 0 END) AS DOLL_KNOWN_SHRINK,
SUM(CASE WHEN A.DEPARTMENT_SOURCE_IDENTIFIER = 47 THEN A.KNOWN_SHRINK_AMT ELSE 0 END) AS TOY_KNOWN_SHRINK,
...
sum(A.TOT_GAPSCAN_QTY) as TOT_GAPSCAN_QTY,
sum(A.TOT_GAPSCAN_AMT) as TOT_GAPSCAN_AMT,
sum(A.TOT_GAPSCAN_QTY)/(((A.END_QUARTER_DATE-A.START_DATE)/7)+1) as AVG_GAPSCAN_QTY,
sum(A.TOT_GAPSCAN_AMT)/(((A.END_QUARTER_DATE-A.START_DATE)/7)+1) as AVG_GAPSCAN_AMT,
count(A.PRODUCT_SOURCE_IDENTIFIER_ZERO_SLS) as PROD_CNT_ZERO_SLS,
count(distinct A.PRODUCT_SOURCE_IDENTIFIER) as PROD_CNT,
sum(A.ONLINE_SHRINK_QTY) as ONLINE_SHRINK_QTY,
sum(A.ONLINE_SHRINK_AMT) as ONLINE_SHRINK_AMT,
sum(A.HEAD_OFFICE_ADJ_QTY) as HEAD_OFFICE_ADJ_QTY,
sum(A.HEAD_OFFICE_ADJ_AMT) as HEAD_OFFICE_ADJ_AMT,
sum(A.HEAD_OFFICE_ADJ_QTY)/(((A.END_QUARTER_DATE-A.START_DATE)/7)+1) as AVG_HEAD_OFFICE_ADJ_QTY,
sum(A.HEAD_OFFICE_ADJ_AMT)/(((A.END_QUARTER_DATE-A.START_DATE)/7)+1) as AVG_HEAD_OFFICE_ADJ_AMT
from
(select A.PRODUCT_SOURCE_IDENTIFIER, A.LOCATION_SOURCE_IDENTIFIER,
A.LOCATION_GENERATED_IDENTIFIER, A.DEPARTMENT_SOURCE_IDENTIFIER, A.START_DATE, 
A.END_QUARTER_DATE, A.END_QUARTER_DATE_TYPE, A.ADJ_START_DATE, A.ADJ_END_DATE,
A.net_adj_qty as TOT_SHRINK_QTY, A.net_adj_amt as TOT_SHRINK_AMT,
A.net_sls_qty as TOT_SALES_QTY, A.net_sls_amt AS TOT_SALES_AMT, A.known_shrink_amt,
(A.net_adj_qty - (code4_neg_adj_qty+code4_pos_adj_qty+code17_neg_adj_qty+code17_pos_adj_qty)) as ALL_SHRINK_WO_STK_QTY,
(A.net_adj_amt - (code4_neg_adj_amt+code4_pos_adj_amt+code17_neg_adj_amt+code17_pos_adj_amt)) as ALL_SHRINK_WO_STK_AMT,
...
case when A.NET_SLS_QTY<=0 then A.net_adj_amt else 0 end as TOT_SHRINK_AMT_ZERO_SLS,
case when A.NET_SLS_QTY<=0 then A.PRODUCT_SOURCE_IDENTIFIER end as PRODUCT_SOURCE_IDENTIFIER_ZERO_SLS 
from KSFPA.LOSS_PREVENTION_PVT.ALL_STK_QRTR_TEST_PROD_LOC_SHRINK_SLS A )A
group by 1,2,3,4,5,6,7) A

inner join 
(select A.M_Store, B.START_DATE, B.END_QUARTER_DATE,
count(distinct case when (C.M_PURCHASE_FROM_STORE = 0 and substr(C.D_PURCHASE, 1, 4) = '1900') then C.M_TRN_ID end) as Refund_no_receipt_Tran,
count(distinct case when (a.A_NETCASH+a.A_NETNCASH) < 0 then A.M_TRN_ID end) as Refund_Tran,
sum(ifnull(C.REFUND_UNITS,0)) as TOTAL_REFUND_QTY, 
sum(case when (C.M_PURCHASE_FROM_STORE = 0 and substr(C.D_PURCHASE, 1, 4) = '1900') then C.REFUND_UNITS else 0 end) as TOTAL_Refund_no_receipt_QTY,
...
and A.D_TRN_DATE = C.D_TRN_DATE
where A.D_TRN_DATE >= B.START_DATE
and A.D_TRN_DATE <= B.END_QUARTER_DATE
--and B.LAST_LAST_STK_DATE is NOT NULL
and IFNULL(a.f_voided,0) = 0
group by 1,2,3) B
on A.LOCATION_SOURCE_IDENTIFIER = B.M_STORE
and A.START_DATE = B.START_DATE
and A.END_QUARTER_DATE = B.END_QUARTER_DATE

inner join 
(select A.LOCATION_GENERATED_IDENTIFIER, D.LOCATION_SOURCE_IDENTIFIER, 
D.START_DATE, D.END_QUARTER_DATE,
sum(case when A.WMS_MANIFEST_TYPE_CODE IN ('H') then A.DESPATCH_QUANTITY else 0 end) as HOUSE_MANIFEST_QTY,
sum(case when A.WMS_MANIFEST_TYPE_CODE IN ('S','H') then A.DESPATCH_QUANTITY else 0 end) as ALL_MANIFEST_QTY
from KSFPA.MR2.WMS_MANIFEST A
inner join
...
on A.PRODUCT_GENERATED_IDENTIFIER = B.PRODUCT_GENERATED_IDENTIFIER
and A.LOCATION_GENERATED_IDENTIFIER = B.LOCATION_GENERATED_IDENTIFIER
inner join KSFPA.LOSS_PREVENTION_PVT.ALL_QRTR_TEST_STRS_STK_DATE D
on A.LOCATION_GENERATED_IDENTIFIER = D.LOCATION_GENERATED_IDENTIFIER
where A.DAY_DATE >= D.START_DATE
and A.DAY_DATE <= D.END_QUARTER_DATE
--and D.LAST_LAST_STK_DATE IS NOT NULL
group by 1,2,3,4) C
on A.LOCATION_GENERATED_IDENTIFIER = C.LOCATION_GENERATED_IDENTIFIER
and A.START_DATE = C.START_DATE
and A.END_QUARTER_DATE = C.END_QUARTER_DATE
...
inner join KSFPA.LOSS_PREVENTION_PVT.ALL_QRTR_TEST_STRS_STK_DATE D
on A.LOCATION_GENERATED_IDENTIFIER = D.LOCATION_GENERATED_IDENTIFIER
where A.WEEK_END_DATE = DATEADD(DAY,-7,D.END_QUARTER_DATE)
--and D.LAST_LAST_STK_DATE IS NOT NULL
and A.STOCK_ON_HAND_QUANTITY < 0
group by 1,2,3,4) D
on A.LOCATION_GENERATED_IDENTIFIER = D.LOCATION_GENERATED_IDENTIFIER
and A.START_DATE = D.START_DATE
and A.END_QUARTER_DATE = D.END_QUARTER_DATE
...
FROM 
(select A.LOCATION_GENERATED_IDENTIFIER, D.LOCATION_SOURCE_IDENTIFIER, 
A.WEEK_END_DATE, D.START_DATE, D.END_QUARTER_DATE, 
sum(A.STOCK_ON_HAND_QUANTITY) as STOCK_ON_HAND_QUANTITY,
sum(A.STOCK_ON_HAND_SELL_AMOUNT-A.STOCK_ON_HAND_MARGIN_AMOUNT) as SOH_COST_AMT,
sum(case when A.STOCK_ON_HAND_QUANTITY < 0 then A.STOCK_ON_HAND_QUANTITY else 0 end) as NEG_SOH_QTY,
sum(case when A.STOCK_ON_HAND_QUANTITY < 0 then (A.STOCK_ON_HAND_SELL_AMOUNT-A.STOCK_ON_HAND_MARGIN_AMOUNT) else 0 end) as NEG_SOH_COST_AMT,
...
on A.LOCATION_GENERATED_IDENTIFIER = D.LOCATION_GENERATED_IDENTIFIER
where A.WEEK_END_DATE >= D.START_DATE
and A.WEEK_END_DATE <= D.END_QUARTER_DATE
--and A.STOCK_ON_HAND_QUANTITY < 0
group by 1,2,3,4,5) A
group by 1,2,3,4) E
on A.LOCATION_GENERATED_IDENTIFIER = E.LOCATION_GENERATED_IDENTIFIER
and A.START_DATE = E.START_DATE
and A.END_QUARTER_DATE = E.END_QUARTER_DATE

inner join
(SELECT LOC.LOCATION_CODE as LOCATION_SOURCE_IDENTIFIER, D.START_DATE, D.END_QUARTER_DATE, 
sum(DIF_ORDERS) as DIF_ORDERS,
sum(ALL_ORDERS) as ALL_ORDERS
FROM KSF_SOPHIA_DATA_INTELLIGENCE_HUB_DEV.SHRINK_TACTICAL.AGG_SHRINK_ONLINE_DIF_PERCENTAGE DIF
INNER JOIN "KSF_SOPHIA_DATA_INTELLIGENCE_HUB_PROD"."COMMON_DIMENSIONS"."DIM_LOCATION" LOC
...
on LOC.LOCATION_CODE = D.LOCATION_SOURCE_IDENTIFIER
where C.CALENDAR_WEEK_END_DATE >= D.START_DATE
and C.CALENDAR_WEEK_END_DATE <= D.END_QUARTER_DATE
GROUP BY 1,2,3) F
on A.LOCATION_SOURCE_IDENTIFIER = F.LOCATION_SOURCE_IDENTIFIER
and A.START_DATE = F.START_DATE
and A.END_QUARTER_DATE = F.END_QUARTER_DATE
...
on A.LOCATION_SOURCE_IDENTIFIER = G.LOCATION_SOURCE_IDENTIFIER
and A.START_DATE = G.START_DATE
and A.END_QUARTER_DATE = G.END_QUARTER_DATE

inner join
(select LOCATION_GENERATED_IDENTIFIER, 
LOCATION_SOURCE_IDENTIFIER, START_DATE, END_QUARTER_DATE,
COUNT(DISTINCT PERIOD_END_DATE)/(((END_QUARTER_DATE-START_DATE)/7)+1) AS GAPSCAN_PERCENT_WEEKS,
AVG(DISTINCT_PROD_CNT) AS AVG_GAPSCAN_PROD_CNT
from
(select A.LOCATION_GENERATED_IDENTIFIER, D.LOCATION_SOURCE_IDENTIFIER, 
D.START_DATE, D.END_QUARTER_DATE, A.PERIOD_END_DATE,
COUNT(DISTINCT A.PRODUCT_GENERATED_IDENTIFIER) AS DISTINCT_PROD_CNT
from KSFPA.MR2.SS_STOCK_ADJUSTMENT A
inner join
(select distinct PRODUCT_GENERATED_IDENTIFIER, LOCATION_GENERATED_IDENTIFIER
...
on A.LOCATION_GENERATED_IDENTIFIER = D.LOCATION_GENERATED_IDENTIFIER
where A.PERIOD_END_DATE >= D.START_DATE
and A.PERIOD_END_DATE <= D.END_QUARTER_DATE
and A.STOCK_ADJUSTMENT_REASON_CODE IN ('20')
group by 1,2,3,4,5) A
group by 1,2,3,4) H
on A.LOCATION_GENERATED_IDENTIFIER = H.LOCATION_GENERATED_IDENTIFIER
and A.START_DATE = H.START_DATE
and A.END_QUARTER_DATE = H.END_QUARTER_DATE;
...
ON A.PRODUCT_GENERATED_IDENTIFIER = B.PRODUCT_GENERATED_IDENTIFIER
where STOCK_ADJUSTMENT_REASON_CODE IN ('04')
AND B.DEPARTMENT_SOURCE_IDENTIFIER NOT IN (99)
GROUP BY 1) B
ON A.LOCATION_GENERATED_IDENTIFIER = B.LOCATION_GENERATED_IDENTIFIER
LEFT JOIN
(SELECT LOCATION_GENERATED_IDENTIFIER,
...
(A.TOY_ALL_SHRINK/TOY_NET_SLS) AS TOY_ALL_SR_RATE,
(A.FAMILY_TECH_ALL_SHRINK/FAMILY_TECH_NET_SLS) AS FAMILY_TECH_ALL_SR_RATE,
CASE WHEN F.ALL_ORDERS IS NULL THEN 0 ELSE (F.DIF_ORDERS/F.ALL_ORDERS) END AS ONLINE_FIRST_DIF_PERCENT,
CASE WHEN G.TOTAL_TRNS IS NULL THEN 0 ELSE (G.DIST_TRNS_WITH_INTRVNS/G.TOTAL_TRNS) END AS SCO_INTERVENTION_PERCENT
from
(select A.LOCATION_SOURCE_IDENTIFIER, A.LOCATION_GENERATED_IDENTIFIER,
A.ADJ_START_DATE, A.START_DATE, 
A.START_DATE_ADJ_TYPE, A.END_DATE,
...
sum(A.TOT_SALES_QTY) as TOT_SALES_QTY,
sum(A.TOT_SALES_AMT) as TOT_SALES_AMT,
sum(A.TOT_SALES_AMT)/(((DATEADD(DAY,-1,A.END_DATE)-A.START_DATE)/7)+1) as AVG_SALES_AMT,
SUM(CASE WHEN A.DEPARTMENT_SOURCE_IDENTIFIER = 20 THEN A.KNOWN_SHRINK_AMT ELSE 0 END) AS COSMETIC_KNOWN_SHRINK,
SUM(CASE WHEN A.DEPARTMENT_SOURCE_IDENTIFIER = 56 THEN A.KNOWN_SHRINK_AMT ELSE 0 END) AS APPLIANCE_KNOWN_SHRINK,
SUM(CASE WHEN A.DEPARTMENT_SOURCE_IDENTIFIER = 67 THEN A.KNOWN_SHRINK_AMT ELSE 0 END) AS DOLL_KNOWN_SHRINK,
SUM(CASE WHEN A.DEPARTMENT_SOURCE_IDENTIFIER = 47 THEN A.KNOWN_SHRINK_AMT ELSE 0 END) AS TOY_KNOWN_SHRINK,
...
sum(A.TOT_GAPSCAN_QTY) as TOT_GAPSCAN_QTY,
sum(A.TOT_GAPSCAN_AMT) as TOT_GAPSCAN_AMT,
sum(A.TOT_GAPSCAN_QTY)/(((DATEADD(DAY,-1,A.END_DATE)-A.START_DATE)/7)+1) as AVG_GAPSCAN_QTY,
sum(A.TOT_GAPSCAN_AMT)/(((DATEADD(DAY,-1,A.END_DATE)-A.START_DATE)/7)+1) as AVG_GAPSCAN_AMT,
count(A.PRODUCT_SOURCE_IDENTIFIER_ZERO_SLS) as PROD_CNT_ZERO_SLS,
count(distinct A.PRODUCT_SOURCE_IDENTIFIER) as PROD_CNT,
sum(A.ONLINE_SHRINK_QTY) as ONLINE_SHRINK_QTY,
sum(A.ONLINE_SHRINK_AMT) as ONLINE_SHRINK_AMT,
sum(A.HEAD_OFFICE_ADJ_QTY) as HEAD_OFFICE_ADJ_QTY,
sum(A.HEAD_OFFICE_ADJ_AMT) as HEAD_OFFICE_ADJ_AMT,
sum(A.HEAD_OFFICE_ADJ_QTY)/(((DATEADD(DAY,-1,A.END_DATE)-A.START_DATE)/7)+1) as AVG_HEAD_OFFICE_ADJ_QTY,
sum(A.HEAD_OFFICE_ADJ_AMT)/(((DATEADD(DAY,-1,A.END_DATE)-A.START_DATE)/7)+1) as AVG_HEAD_OFFICE_ADJ_AMT
from
(select A.PRODUCT_SOURCE_IDENTIFIER, A.LOCATION_SOURCE_IDENTIFIER,
A.LOCATION_GENERATED_IDENTIFIER, A.DEPARTMENT_SOURCE_IDENTIFIER, A.ADJ_START_DATE, 
...
(select LOCATION_GENERATED_IDENTIFIER, 
LOCATION_SOURCE_IDENTIFIER, START_DATE, END_DATE,
COUNT(DISTINCT PERIOD_END_DATE)/(((DATEADD(DAY,-1,END_DATE)-START_DATE)/7)+1) AS GAPSCAN_PERCENT_WEEKS,
AVG(DISTINCT_PROD_CNT) AS AVG_GAPSCAN_PROD_CNT
from
(select A.LOCATION_GENERATED_IDENTIFIER, D.LOCATION_SOURCE_IDENTIFIER, 
D.START_DATE, D.END_DATE, A.PERIOD_END_DATE,
...
---------------------------Generating previous Shrink rate for all stores-------------------------------
...
AND A.LAST_STK_END_DATE = '2022-08-21';


DROP TABLE KSFPA.LOSS_PREVENTION_PVT.PAST_STK_PROD_LOC_SHRINK_SLS;
CREATE TABLE KSFPA.LOSS_PREVENTION_PVT.PAST_STK_PROD_LOC_SHRINK_SLS AS
SELECT A.PRODUCT_GENERATED_IDENTIFIER, C.PRODUCT_SOURCE_IDENTIFIER,
C.PRODUCT_DESCRIPTION, C.DEPARTMENT_SOURCE_IDENTIFIER, C.DEPARTMENT_DESCRIPTION, 
C.RBU_DESCRIPTION, C.BRAND_DESCRIPTION, C.HOUSEBRAND_NAME, 
C.BRAND_LABEL_DESCRIPTION, kc_flexi.BRAND_LABEL_TYPE,
...
B.START_DATE_ADJ_TYPE, B.END_DATE
from KSFPA.MR2C.WEEKLY_ADJUSTED_SALES A
inner join KSFPA.LOSS_PREVENTION_PVT.ALL_STRS_PAST_STK_DATE B
on A.LOCATION_GENERATED_IDENTIFIER = B.LOCATION_GENERATED_IDENTIFIER
--where B.START_DATE_ADJ_TYPE IN ('STK_ADJ')
--A.WEEK_END_DATE >= B.START_DATE
--and A.WEEK_END_DATE <= '2020-11-29'
where A.WEEKLY_NET_SELL_AMOUNT != 0) 
UNION 
(select distinct A.PRODUCT_GENERATED_IDENTIFIER, A.LOCATION_GENERATED_IDENTIFIER,
B.ADJ_START_DATE, B.START_DATE, 
B.START_DATE_ADJ_TYPE, B.END_DATE
...
--A.WEEK_END_DATE >= B.START_DATE
--and A.WEEK_END_DATE <= '2020-11-29'
where A.STOCK_ADJUSTMENT_COST_AMOUNT != 0
and A.STOCK_ADJUSTMENT_REASON_CODE IN ('00', '02', '03', '04', '05', '06', '07', '08', '11', '17', '20', '21', '29', '34', '35', '36', '37', '50', '51', '53', '54', '55', '56', '57', '58', '60', '61', '62', '63', '64', '65', '66', '67', '68', '69', '70', 'NS', 'NP')) ) A
...
select A.LOCATION_GENERATED_IDENTIFIER,
A.LOCATION_SOURCE_IDENTIFIER, A.START_DATE, A.END_DATE,
sum(A.net_adj_amt) as TOT_SHRINK_AMT,
sum(A.net_sls_amt) AS TOT_SALES_AMT,
(sum(A.net_adj_amt)/sum(A.net_sls_amt)) as Shrink_Rate
from KSFPA.LOSS_PREVENTION_PVT.PAST_STK_PROD_LOC_SHRINK_SLS A
group by 1,2,3,4
having sum(A.net_sls_amt) > 0;





---------------------------Generating recent stocktake Shrink rate for all stores-------------------------------
...
DROP TABLE KSFPA.LOSS_PREVENTION_PVT.PAST_STK_MATURE_STR_PROD_LOC_SHRINK_SLS;
CREATE TABLE KSFPA.LOSS_PREVENTION_PVT.PAST_STK_MATURE_STR_PROD_LOC_SHRINK_SLS AS
SELECT A.PRODUCT_GENERATED_IDENTIFIER, C.PRODUCT_SOURCE_IDENTIFIER,
C.PRODUCT_DESCRIPTION, C.DEPARTMENT_SOURCE_IDENTIFIER, C.DEPARTMENT_DESCRIPTION, 
C.RBU_DESCRIPTION, C.BRAND_DESCRIPTION, C.HOUSEBRAND_NAME, 
C.BRAND_LABEL_DESCRIPTION, kc_flexi.BRAND_LABEL_TYPE,
...
SUM(CASE WHEN A.DEPARTMENT_SOURCE_IDENTIFIER = 47 THEN A.ALL_SHRINK_WO_STK_AMT ELSE 0 END) AS TOY_ALL_SHRINK,
SUM(CASE WHEN A.DEPARTMENT_SOURCE_IDENTIFIER = 75 THEN A.ALL_SHRINK_WO_STK_AMT ELSE 0 END) AS FAMILY_TECH_ALL_SHRINK,
SUM(CASE WHEN A.DEPARTMENT_SOURCE_IDENTIFIER = 20 THEN A.TOT_SHRINK_AMT ELSE 0 END) AS COSMETIC_NET_ADJ_AMT,
SUM(CASE WHEN A.DEPARTMENT_SOURCE_IDENTIFIER = 56 THEN A.TOT_SHRINK_AMT ELSE 0 END) AS APPLIANCE_NET_ADJ_AMT,
SUM(CASE WHEN A.DEPARTMENT_SOURCE_IDENTIFIER = 67 THEN A.TOT_SHRINK_AMT ELSE 0 END) AS DOLL_NET_ADJ_AMT,
SUM(CASE WHEN A.DEPARTMENT_SOURCE_IDENTIFIER = 47 THEN A.TOT_SHRINK_AMT ELSE 0 END) AS TOY_NET_ADJ_AMT,
SUM(CASE WHEN A.DEPARTMENT_SOURCE_IDENTIFIER = 75 THEN A.TOT_SHRINK_AMT ELSE 0 END) AS FAMILY_TECH_NET_ADJ_AMT,
SUM(CASE WHEN A.DEPARTMENT_SOURCE_IDENTIFIER = 20 THEN A.TOT_SALES_AMT ELSE 0 END) AS COSMETIC_NET_SLS,
SUM(CASE WHEN A.DEPARTMENT_SOURCE_IDENTIFIER = 56 THEN A.TOT_SALES_AMT ELSE 0 END) AS APPLIANCE_NET_SLS,
SUM(CASE WHEN A.DEPARTMENT_SOURCE_IDENTIFIER = 67 THEN A.TOT_SALES_AMT ELSE 0 END) AS DOLL_NET_SLS,
SUM(CASE WHEN A.DEPARTMENT_SOURCE_IDENTIFIER = 47 THEN A.TOT_SALES_AMT ELSE 0 END) AS TOY_NET_SLS,
...
case when A.NET_SLS_QTY<=0 then A.net_adj_amt else 0 end as TOT_SHRINK_AMT_ZERO_SLS,
case when A.NET_SLS_QTY<=0 then A.PRODUCT_SOURCE_IDENTIFIER end as PRODUCT_SOURCE_IDENTIFIER_ZERO_SLS 
from KSFPA.LOSS_PREVENTION_PVT.PAST_STK_MATURE_STR_PROD_LOC_SHRINK_SLS A
inner join KSFPA.LOSS_PREVENTION_PVT.ALL_STRS_PAST_STK_DATE B
on A.LOCATION_SOURCE_IDENTIFIER = B.LOCATION_SOURCE_IDENTIFIER )A
group by 1,2,3,4,5,6) A
...
inner join
(select distinct PRODUCT_GENERATED_IDENTIFIER, LOCATION_GENERATED_IDENTIFIER
from KSFPA.LOSS_PREVENTION_PVT.PAST_STK_MATURE_STR_PROD_LOC_SHRINK_SLS) B
on A.PRODUCT_GENERATED_IDENTIFIER = B.PRODUCT_GENERATED_IDENTIFIER
and A.LOCATION_GENERATED_IDENTIFIER = B.LOCATION_GENERATED_IDENTIFIER
inner join KSFPA.LOSS_PREVENTION_PVT.ALL_STRS_PAST_STK_DATE D
on A.LOCATION_GENERATED_IDENTIFIER = D.LOCATION_GENERATED_IDENTIFIER
where A.DAY_DATE >= D.START_DATE
and A.DAY_DATE <= D.END_DATE
--and D.LAST_LAST_STK_DATE IS NOT NULL
...
---------------------------Generating previous to previous Shrink rate for all stores-------------------------------


DROP TABLE KSFPA.LOSS_PREVENTION_PVT.ALL_STRS_PAST_PAST_STK_DATE;
CREATE TABLE KSFPA.LOSS_PREVENTION_PVT.ALL_STRS_PAST_PAST_STK_DATE AS 
select A.LOCATION_GENERATED_IDENTIFIER,
A.LOCATION_SOURCE_IDENTIFIER,
IFNULL(A.LAST_LAST_LAST_STK_DATE, A.LAST_LAST_STK_START_DATE) AS ADJ_START_DATE,
A.LAST_LAST_STK_START_DATE AS START_DATE, A.LAST_LAST_STK_END_DATE AS END_DATE,
CASE WHEN A.LAST_LAST_LAST_STK_DATE IS NULL THEN 'FIRST_ADJ' ELSE 'STK_ADJ' END AS START_DATE_ADJ_TYPE
from KSFPA.LOSS_PREVENTION_PVT.STK_STRS_WITH_STK_DATE_VD A
where LAST_LAST_STK_DATE IS NOT NULL
AND A.LAST_LAST_STK_END_DATE = '2022-02-20';


DROP TABLE KSFPA.LOSS_PREVENTION_PVT.PAST_PAST_STK_PROD_LOC_SHRINK_SLS;
CREATE TABLE KSFPA.LOSS_PREVENTION_PVT.PAST_PAST_STK_PROD_LOC_SHRINK_SLS AS
SELECT A.PRODUCT_GENERATED_IDENTIFIER, C.PRODUCT_SOURCE_IDENTIFIER,
C.PRODUCT_DESCRIPTION, C.DEPARTMENT_SOURCE_IDENTIFIER, C.DEPARTMENT_DESCRIPTION, 
C.RBU_DESCRIPTION, C.BRAND_DESCRIPTION, C.HOUSEBRAND_NAME, 
C.BRAND_LABEL_DESCRIPTION, kc_flexi.BRAND_LABEL_TYPE,
...
B.START_DATE_ADJ_TYPE, B.END_DATE
from KSFPA.MR2C.WEEKLY_ADJUSTED_SALES A
inner join KSFPA.LOSS_PREVENTION_PVT.ALL_STRS_PAST_PAST_STK_DATE B
on A.LOCATION_GENERATED_IDENTIFIER = B.LOCATION_GENERATED_IDENTIFIER
--where B.START_DATE_ADJ_TYPE IN ('STK_ADJ')
--A.WEEK_END_DATE >= B.START_DATE
--and A.WEEK_END_DATE <= '2020-11-29'
...
sum(A.net_sls_amt) AS TOT_SALES_AMT,
(sum(A.net_adj_amt)/sum(A.net_sls_amt)) as Shrink_Rate
from KSFPA.LOSS_PREVENTION_PVT.PAST_PAST_STK_PROD_LOC_SHRINK_SLS A
group by 1,2,3,4
having sum(A.net_sls_amt) > 0;
